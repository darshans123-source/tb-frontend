...
export default function PediatricScoreCalculator() {
  ...
  return (
    <div className="p-6 bg-slate-900 border border-purple-500/30 rounded-3xl text-white shadow-[0_0_30px_rgba(168,85,247,0.15)] space-y-6">
      <div className="flex justify-between items-center pb-4 border-b border-slate-800">
        <div className="flex items-center gap-3">
          <div className="p-2.5 bg-purple-950 border border-purple-500/40 rounded-2xl text-purple-400">
            <Calculator size={24} />
          </div>
          <div>
            <h3 className="text-xl font-bold text-white">Pediatric TB Composite Score Calculator</h3>
            <p className="text-slate-400 text-xs font-mono">National Pediatric Diagnostic Guideline Tool (Page 22 Reference)</p>
          </div>
        </div>

        <button
          onClick={handleReset}
          className="flex items-center gap-1.5 px-3.5 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-xl text-xs font-semibold transition-colors"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          ...
          >
            ...
            {hasCough ? <CheckSquare size={18} className="text-purple-400" /> : <Square size={18} />}
          </button>
          ...
          >
            ...
            {hasFever ? <CheckSquare size={18} className="text-purple-400" /> : <Square size={18} />}
          </button>
          ...
          >
            ...
            {hasWeightLoss ? <CheckSquare size={18} className="text-purple-400" /> : <Square size={18} />}
          </button>
          ...
          >
            ...
            {hasLymphNode ? <CheckSquare size={18} className="text-purple-400" /> : <Square size={18} />}
          </button>
          ...
          >
            ...
            {tstPositive ? <CheckSquare size={18} className="text-purple-400" /> : <Square size={18} />}
          </button>
          ...
          >
            ...
            {hasContactHistory ? <CheckSquare size={18} className="text-purple-400" /> : <Square size={18} />}
          </button>
          ...
          >
            ...
            {cxrSuggestive ? <CheckSquare size={18} className="text-purple-400" /> : <Square size={18} />}
          </button>
        </div>

        {/* Calculated Result Panel */}
        <div className="bg-slate-950 border border-purple-500/30 rounded-2xl p-6 flex flex-col justify-between text-center shadow-inner">
          <div className="space-y-4">
            <p className="text-xs font-mono uppercase text-slate-400">Total Pediatric TB Score</p>

            <div className="inline-flex items-center justify-center w-28 h-28 bg-purple-950 border-2 border-purple-500 rounded-full shadow-[0_0_25px_rgba(168,85,247,0.3)]">
              <span className="text-5xl font-black font-mono text-purple-300">{score}</span>
            </div>
            ...
            <div className={`p-4 rounded-xl border text-xs leading-relaxed font-bold ${
              ...
              {isHighRisk ? (
                <div>
                  <p className="text-base font-extrabold mb-1">SCORE ≥ 6: HIGH PROBABILITY OF ACTIVE TB</p>
                ...
                <div>
                  <p className="text-base font-extrabold mb-1">SCORE &lt; 6: LOW / INCONCLUSIVE SCORE</p>
                  <p className="font-normal text-[11px]">
