...
class AIService {
  /**
   * Responds to user clinical queries using local pre-written high quality medical response dataset.
   * Matches keywords or falls back to standard NTEP/CDC guideline answer.
   */
